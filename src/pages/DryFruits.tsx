...
const dryFruitsProducts = [
  {
    ...
    price: 450,
    originalPrice: 550,
    image: '/products/dryfruits/dates.svg',
    category: 'Dry Fruits',
    inStock: true,
    isNew: true,
    rating: 4.9
  },
  {
    ...
    name: 'Dried Figs',
    price: 850,
    image: '/products/dryfruits/figs.svg',
    category: 'Dry Fruits',
    inStock: true,
    rating: 4.7
  },
  {
    ...
    price: 320,
    originalPrice: 380,
    image: '/products/dryfruits/raisins.svg',
    category: 'Dry Fruits', 
    inStock: true,
    rating: 4.6
  },
  {
    ...
    name: 'Dried Apricots',
    price: 950,
    image: '/products/dryfruits/apricots.svg',
    category: 'Dry Fruits',
    inStock: false,
    rating: 4.8
  },
  {
    ...
    price: 1200,
    image: '/products/dryfruits/mixed-dryfruits.svg',
    category: 'Dry Fruits',
    inStock: true,
    isNew: true,
    rating: 4.5
  },
  {
    ...
    price: 650,
    originalPrice: 750,
    image: '/products/dryfruits/cranberries.svg',
    category: 'Dry Fruits',
    inStock: true,
    rating: 4.4
  }
  ...
  const filteredProducts = dryFruitsProducts
    .filter((product): product is typeof product & { 
      ...
      if (filterBy === "inStock") {
        ...
        matchesFilter = !!product.originalPrice;
      }
